...
# клавиатуры. В ответе напишите “Парам пам-пам”, если с ритмом все в порядке и “Пам парам”, если с ритмом 
# все не в порядке
...
poem = [len([i for i in letter if i.lower() in "уеёэоаыяию"]) for letter in input().split()]
